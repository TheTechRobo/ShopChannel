...
<?php
// Include config file
require_once 'http://spot.norment.in.nf/spotstoreset.php';
    // Close connection
    mysqli_close($link);
}
?>
...
function initPageCommon()
{
	...
	ossPath = "http://dc24wsc.22web.org/oss/serv/";
	secureOssPath = "http://dc24wsc.22web.org/oss/serv/";	
...
<div id="S_02">
	...
	If you are a Club Spot member, you can link your Username to your Open Shop Channel now. By linking, your future Wii downloads will automatically be registered to your Club Spot account, and you will be eligible to earn exclusive rewards. For details, see norment.in.nf/ecc.<BR> <BR>Note: If you link your Username on a second Wii console, it will be unlinked from the first Wii console.<BR><BR>Club Spot Membership is not required to use the Open Shop Channel.</div>
