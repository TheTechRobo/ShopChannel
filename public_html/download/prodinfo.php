...
<body>
		...
		<!--info section-->
		<p class="textPlatform">Type</p>
		<p class="textNormal">
			Released MM/DD/YYYY<br>
			Creator Name<br>
			Genre
		</p>
		<p class="textNormal" style="left: 400px;">For # player(s)</p>
			<p class="textTitle">Product Name Here</p>
		<img src="../asset/temporary/icon.png" class="imageScreenshot"><!--Product icon here-->
