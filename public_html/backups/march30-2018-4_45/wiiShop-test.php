...
<!-- <button onmousedown="shop.jumpDataMng()">go to data management</button> seems to be documented, but doesn't work for me-->
...
<hr size="1" noshade>
<p><a href="main.php">i wanna go home</a> (btw, things that don't work are commented out)</p>
<p id="testok"></p>
